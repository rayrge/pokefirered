const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] = {
    ...
    [MOVE_XSCISSORS]     = _("X-SCISSORS"),
    [MOVE_HP_FIGHTING] = _("HP FIGHTING"),
    [MOVE_HP_FLYING] = _("HP FLYING"),
    [MOVE_HP_POISON] = _("HP POISON"),
    [MOVE_HP_GROUND] = _("HP GROUND"),
    [MOVE_HP_ROCK] = _("HP ROCK"),
    [MOVE_HP_BUG] = _("HP BUG"),
    [MOVE_HP_GHOST] = _("HP GHOST"),
    [MOVE_HP_STEEL] = _("HP STEEL"),
    [MOVE_HP_FIRE] = _("HP FIRE"),
    [MOVE_HP_WATER] = _("HP WATER"),
    [MOVE_HP_GRASS] = _("HP GRASS"),
    [MOVE_HP_ELECTRIC] = _("HP ELECTRIC"),
    [MOVE_HP_PSYCHIC] = _("HP PSYCHIC"),
    [MOVE_HP_ICE] = _("HP ICE"),
