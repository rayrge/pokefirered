const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_WEEPINBELL] = {{EVO_LEVEL, 25, SPECIES_VICTREEBEL}},
    ...
    [SPECIES_SENTRET]    = {{EVO_LEVEL, 16, SPECIES_FURRET}},
    ...
    [SPECIES_HOPPIP]     = {{EVO_LEVEL, 17, SPECIES_SKIPLOOM}},
    [SPECIES_SKIPLOOM]   = {{EVO_LEVEL, 39, SPECIES_JUMPLUFF}},
