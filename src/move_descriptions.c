...
const u8 gMoveDescription_VitalThrow[] = _("This move will not\nmiss.");
...
const u8 gMoveDescription_WaterSpout[] = _("An ultimate\nblast of water.\nHurts the user.");
...
const u8 gMoveDescription_AquaJet[] = _("A jet of water\nthat always strikes\nfirst.");
