...
const u8 gMoveDescription_HiddenPowerAll[] = _("A hardcoded\nattack of a varying\ntype.");
...
const u8 gMoveDescription_AquaJet[] = _("A quick jet of\nwater.");
...
const u8 gMoveDescription_EarthPower[] = _("Can Lower the\n foe's defense.");
...
const u8 *const gMoveDescriptionPointers[MOVES_COUNT - 1] = {
    ...
    [MOVE_HP_FIGHTING - 1]          = gMoveDescription_HiddenPowerAll,
    [MOVE_HP_FLYING - 1]            = gMoveDescription_HiddenPowerAll,
    [MOVE_HP_POISON - 1]            = gMoveDescription_HiddenPowerAll,
    [MOVE_HP_GROUND - 1]            = gMoveDescription_HiddenPowerAll,
    [MOVE_HP_ROCK - 1]              = gMoveDescription_HiddenPowerAll,
    [MOVE_HP_BUG - 1]               = gMoveDescription_HiddenPowerAll,
    [MOVE_HP_GHOST - 1]             = gMoveDescription_HiddenPowerAll,
    [MOVE_HP_STEEL - 1]             = gMoveDescription_HiddenPowerAll,
    [MOVE_HP_FIRE - 1]              = gMoveDescription_HiddenPowerAll,
    [MOVE_HP_WATER - 1]             = gMoveDescription_HiddenPowerAll,
    [MOVE_HP_GRASS - 1]             = gMoveDescription_HiddenPowerAll,
    [MOVE_HP_ELECTRIC - 1]          = gMoveDescription_HiddenPowerAll,
    [MOVE_HP_PSYCHIC - 1]           = gMoveDescription_HiddenPowerAll,
